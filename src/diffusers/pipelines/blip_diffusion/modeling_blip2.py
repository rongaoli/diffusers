...
# There is an implementation of Blip2 in `transfor...
...
class Blip2TextEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # self.LayerNorm is not snake-cased to sti...
...
# The Qformer encoder, which takes the visual embe...
...
# Copy-pasted from transformers.models.blip.modeli...
...
class Blip2VisionModel(Blip2PreTrainedModel):
    ...
    def get_extended_attention_mask(
        ...
        if attention_mask.dim() == 3:
            ...
            # - the model is an encoder, so make t...
    ...
    def forward(
        ...
        # and head_mask is converted to shape [num...
