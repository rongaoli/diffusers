...
def load_sub_model(
    ...
    class object of module as well as potential parent class objects"""
    component_folder = os.path.join(cache_dir, component_name) if component_name and cache_dir else None
...
def load_sub_model(
    ...
    # For transformers models >= 4.56.0, use 'dtyp...
    ...
    # When loading a transformers model, if the de...
    # To make default loading faster we set the `l...
    ...
    if is_diffusers_model or is_transformers_model:
        ...
        # if `from_flax` and model is transformer...
...
def _update_init_kwargs_with_connected_pipeline(
    ...
    # https://github.com/huggingface/diffusers/blo...
    ...
    for prefix, connected_pipe in connected_pipes.items():
        # add connected pipes to `init_kwargs` wit...
        init_kwargs.update(
...
def _download_dduf_file(
    ...
    try:
        ...
        # Means we tried to load pipeline with `lo...
        # This can happen in two cases:
        # 1. If the user passed `local_files_only=...
        # 2. If we forced `local_files_only=True`...
