...
class HunyuanDiTAttentionPool(nn.Module):
    # Copied from https://github.com/Tencent/Hunyu...
...
class AttentionPooling(nn.Module):
    # Copied from https://github.com/deep-floyd/IF...
...
# Modified from https://github.com/mlfoundations/o...
...
class MultiIPAdapterImageProjection(nn.Module):
    ...
    def forward(self, image_embeds: List[torch.Tensor]):
        ...
        #  1. a tensor (deprecated) with shape [ba...
        #  2. list of `n` tensors where `n` is num...
