...
class WanAnimateFaceBlockAttnProcessor:
    ...
    def __call__(
        ...
        # B --> batch_size, T --> reduced inferenc...
        ...
        # encoder_hidden_states (the motion vector...
        # post-patchify sequence length S of the t...
...
class WanAnimateFaceBlockCrossAttention(nn.Module, AttentionModuleMixin):
    ...
    def __init__(
        ...
        # 1. Pre-Attention Norms for the hidden_st...
...
class WanAnimateTransformer3DModel(
    ...
    def forward(
        ...
        # Calling contiguous() here is important s...
        ...
        # Perform batched motion encoder inference...
        ...
        for block_idx, block in enumerate(self.blocks):
            ...
            if block_idx % self.config.inject_face_latents_blocks == 0:
                ...
                # In case the face adapter and mai...
