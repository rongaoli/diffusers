...
class Flux2SingleTransformerBlock(nn.Module):
    def __init__(
        ...
        # Note that the MLP in/out linear layers a...
        # is often called a "parallel" transformer...
    ...
    def forward(
        ...
        # If encoder_hidden_states is None, hidden...
        # concatenated
        if encoder_hidden_states is not None:
...
class Flux2PosEmbed(nn.Module):
    # modified from https://github.com/black-fores...
...
class Flux2Transformer2DModel(
    ...
    def __init__(
        ...
        # Two sets of shift/scale/gate modulation...
        self.double_stream_modulation_img = Flux2Modulation(self.inner_dim, mod_param_sets=2, bias=False)
        self.double_stream_modulation_txt = Flux2Modulation(self.inner_dim, mod_param_sets=2, bias=False)
        # Only one set of modulation parameters as...
