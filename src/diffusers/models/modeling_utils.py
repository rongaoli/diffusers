...
def get_parameter_device(parameter: torch.nn.Module) -> torch.device:
    ...
    try:
        # If the onload device is not available du...
...
def get_parameter_dtype(parameter: torch.nn.Module) -> torch.dtype:
    ...
    # 2. If no dtype modifying hooks are attached,...
    last_dtype = None
...
class ModelMixin(torch.nn.Module, PushToHubMixin):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        # call PyTorch's https://pytorch.org/docs/...
    ...
    def enable_layerwise_casting(
        ...
        if is_peft_available() and not user_provided_patterns:
            # By default, we want to skip all peft...
    ...
    def set_attention_backend(self, backend: str) -> None:
        class definition. If you believe this is a mistake, please "
                f"open an issue at https://github.com/huggingface/diffusers/issues."
            )
        ...
        **kwargs,
        ...
        if is_main_process:
            for filename in os.listdir(save_directory):
                ...
                # make sure that file to be delete...
                if (
        ...
        for filename, tensors in state_dict_split.filename_to_tensors.items():
            ...
            if safe_serialization:
                # At some point we will need to de...
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs) -> Self:
        ...
        if hf_quantizer is not None:
            ...
            # In order to ensure popular quantizat...
        ...
        # 2. If torch_dtype is float8, we don't us...
        dtype_orig = None
        ...
        if hf_quantizer is not None:
            ...
            # the model config because `_pre_quant...
    ...
    def _load_pretrained_model(
        ...
        # Some models may have keys that are not i...
        # the user.
        ...
        # If a device map has been used, we can sp...
        # If we don't warmup, each tensor allocati...
        # lot of individual calls to device malloc...
        # tensors using their expected shape and n...
        # When the actual device allocations happe...
        ...
        if state_dict is not None:
            ...
            # if state dict is not None, it means...
    ...
    def _get_no_split_modules(self, device_map: str):
        class as a list/tuple of class names (strings). Every
    ...
    def num_parameters(self, only_trainable: bool = False, exclude_embeddings: bool = False) -> int:
        ...
        for param in total_parameters:
            if param.requires_grad or not only_trainable:
                # For 4bit models, we need to mult...
...
class LegacyModelMixin(ModelMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        # Create a copy of the kwargs so that we d...
